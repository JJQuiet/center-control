...
public class BasicController {
    ...
    public String change_status(@RequestParam String instruction) throws ExecutionException, InterruptedException, TimeoutException {
        //打印参数
        //调用tcpClientService发送消息
        requestType = "change_status";
        String res = tcpClientService.send(instruction, GlobalConfig.centerIp);
        log.info("res:{}",res);
        return res;
    }
    @GetMapping("/status")
